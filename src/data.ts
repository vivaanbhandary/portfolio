...
export const PersonalInfo: AboutMeData = {
  ...
  description: "I grew up playing games and love 100%-ing them. This developed a love for game mechanics and learning their intricacies, which in turn led to loving making them! I am interested in Game Mechanics, Engines, Design, and Graphics. Looking for a new grad position currently!",
  image: `${process.env.PUBLIC_URL}/images/Profile.jpg`,
  cvUri: `${process.env.PUBLIC_URL}/files/Vivaan_Bhandary_Resume.pdf`,
  links: {
...
export const games: Game[] = [
  {
    ...
    tools: ["C++", "Godot", "EnTT", "OpenGL", "GLSL", "miniaudio", "Visual Studio Profiler", "Git"],
    techniques: ["Entity-Component-System", "Spatial Hashing", "Collision Layers", "Co-operative enemy AI", "BOIDs", "Procedural Map Generation (Perlin Noise)"],
    engine: [GameEngine.C, GameEngine.Godot],
    links: [],
    media: [{ source: "https://youtu.be/vicRos5-uT4", type: MediaType.YouTube }, 
      { source: "/images/games/Reloaded_Dice/gameplay.png", type: MediaType.Image },
      { source: "/images/games/Reloaded_Dice/upgrades.png", type: MediaType.Image },
      { source: "/images/games/Reloaded_Dice/bossfight.png", type: MediaType.Image },
    ],
  },
  // {
  ...
  // },
  {
    ...
    media: [{ source: "https://youtu.be/3WiZiLgCb98", type: MediaType.YouTube },
      ...
      { source: "/images/games/Ordinary_Walk/day5.png", type: MediaType.Image },
    ],
  },
  {
    ...
    links: [],
    articleUrl: "/music-essay", 
  },
  {
    name: "Computer Graphics and Animation Projects",
    date: "2025",
    ...
    learningOutcomes: [
      ...
      "Familiarity with game engines' graphical workflows and asset pipelines."
    ],
    genres: ["Tech Demo", "3D Graphics"],
    tools: ["Javascript", "Python", "three.js", "GLSL", "WebGL", "NVIDIA warp", "Git"],
    techniques: ["Dynamic Lighting (Gouraud shading & Blinn-Phong reflections)", "Shadow Mapping", "Ray Marching & Signed Distance Functions (SDF)", "Physically Based Rendering", "Anti-Aliasing (PCF)", "Cloth Simulation", "Shader Programming"],
    engine: [GameEngine.JS, GameEngine.Python],
    links: [],
    media: [{ source: "https://youtu.be/5Nx-kJLup5U", type: MediaType.YouTube },
      { source: "https://youtu.be/pDEL9mPYG38", type: MediaType.YouTube },
      { source: "https://youtu.be/j5XJjoCdnK8", type: MediaType.YouTube },
      { source: "https://youtu.be/iic8mHHe_gQ", type: MediaType.YouTube },
      { source: "/images/games/Graphics_Demos/Reflections.png", type: MediaType.Image },
      { source: "/images/games/Graphics_Demos/Shadows.png", type: MediaType.Image },
    ],
  },
  {
    name: "ESCAPE CAVE",
    ...
    techniques: ["Level Design", "Puzzle Design", "ARG Elements", "Meta Narrative"],
    engine: [GameEngine.Twine],
    links: [],
    media: [{ source: "/images/games/Escape_Cave/guide-1.png", type: MediaType.Image },
      { source: "/images/games/Escape_Cave/door.png", type: MediaType.Image },
      { source: "/images/games/Escape_Cave/map.png", type: MediaType.Image },
      { source: "/images/games/Escape_Cave/journal.png", type: MediaType.Image },
      { source: "/images/games/Escape_Cave/guide-2.png", type: MediaType.Image },
      { source: "/images/games/Escape_Cave/guide-3.png", type: MediaType.Image },
  ...
  },
  {
    ...
    engine: [GameEngine.Twine],
    links: [],
    media: [{ source: "/images/games/Fight_or_Flight/opening.png", type: MediaType.Image },
      { source: "/images/games/Fight_or_Flight/midgame.png", type: MediaType.Image },
      { source: "/images/games/Fight_or_Flight/map.png", type: MediaType.Image }, 
    ],
  },
  {
    ...
    genres: ["Game Design Document", "Narrative Design", "Writeup"],
    engine: [],
    links: [],
    media: [{ source: "/images/games/Echoes_of_Lumina/gameplay.png", type: MediaType.Image },
      { source: "/images/games/Echoes_of_Lumina/characters.png", type: MediaType.Image },
      { source: "/images/games/Echoes_of_Lumina/intro.png", type: MediaType.Image },
      { source: "/images/games/Echoes_of_Lumina/dialogue.png", type: MediaType.Image },
      { source: "/images/games/Echoes_of_Lumina/barks.png", type: MediaType.Image },
    ],
  },
  {
    name: "Zone Chaser",
    ...
    genres: ["Retro", "Casual"],
    tools: ["Java", "Swing"],
    techniques: ["Object Oriented Programming", "Collision Detection", "Saving and Loading Game State", "Basic GUI Design"],
    engine: [GameEngine.Java],
    links: [],
    media: [{ source: "https://youtu.be/9I213NTIwCI", type: MediaType.YouTube }],
  },
];